            ...
            >
                ...
                <div className="p-6 border-b flex items-center justify-between bg-slate-50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-slate-800">העלאה חכמה מהירה</h2>
                            <p className="text-xs text-slate-500">הפיכת תמונה או PDF לרשימת תלמידים בתוך שניות</p>
                        </div>
                    </div>
                    <button 
                        onClick={handleClose}
                        ...
                        {step === 'upload' && (
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {/* Camera Option (Optimized for Mobile) */}
                                    <button 
                                        onClick={() => {
                                            if (fileInputRef.current) {
                                        ...
                                        className="group p-6 border-2 border-teal-200 rounded-2xl hover:border-teal-400 hover:bg-teal-50 transition-all flex flex-col items-center gap-3 text-center bg-white shadow-sm"
                                    >
                                        <div className="p-4 bg-teal-100 text-teal-600 rounded-full group-hover:scale-110 transition-transform">
                                            <CameraIcon className="h-8 w-8" />
                                        </div>
                                        <div>
                                            <h3 className="text-lg font-bold text-slate-700">צלמו מהנייד</h3>
                                            <p className="text-xs text-slate-500 mt-1">צילום ישיר של דף הרשימה</p>
                                        </div>
                                    </button>

                                    {/* Upload Option (PDF/Image) */}
                                    <button 
                                        onClick={() => {
                                            if (fileInputRef.current) {
                                        ...
                                        className="group p-6 border-2 border-sky-200 rounded-2xl hover:border-sky-400 hover:bg-sky-50 transition-all flex flex-col items-center gap-3 text-center bg-white shadow-sm"
                                    >
                                        <div className="p-4 bg-sky-100 text-sky-600 rounded-full group-hover:scale-110 transition-transform">
                                            <UploadIcon className="h-8 w-8" />
                                        </div>
                                        <div>
                                            <h3 className="text-lg font-bold text-slate-700">העלאת קובץ</h3>
                                            <p className="text-xs text-slate-500 mt-1">תמונה או PDF מהמחשב</p>
                                        </div>
                                    </button>
                                ...
                                <div className="bg-amber-50 p-4 rounded-xl border border-amber-100 flex items-start gap-3">
                                    ...
                                    <div className="text-sm text-amber-800">
                                        <p className="font-bold mb-1">איך להצליח בסריקה?</p>
                                        <ul className="list-disc list-inside space-y-1 text-xs">
                                            <li>ודאו שהדף ישר והטקסט ברור</li>
                                            <li>בצילום מהנייד - צלמו מלמעלה בתקריב</li>
                                            <li>Gemini מזהה כתב יד, אבל כתב דפוס עובד הכי טוב!</li>
                                        </ul>
                                    </div>
                                </div>
                            </motion.div>
