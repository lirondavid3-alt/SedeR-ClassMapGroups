...
const RowsSettings: React.FC<{
    ...
    isReadOnly?: boolean;
}> = ({ layoutDetails, onLayoutDetailsChange, handleLevelConsiderationChange, isReadOnly }) => {
...
const GroupsSettings: React.FC<{
    ...
    isReadOnly?: boolean;
}> = ({ layoutDetails, handleDetailChange, groupingMethod, setGroupingMethod, isReadOnly }) => (
    <div className="space-y-6">
                            ...
                            <div className="bg-white p-10 rounded-xl shadow-lg max-w-lg mx-auto text-right border-t-4 border-teal-500">
                                ...
                                <div className="space-y-6">
                                    <div className="flex gap-4 items-start">
                                        <div className="flex-shrink-0 w-8 h-8 bg-teal-100 text-teal-600 rounded-full flex items-center justify-center font-bold shadow-sm mt-0.5">1</div>
                                        <div>
                                            <p className="font-bold text-slate-800 text-base">הגדירו את מבנה הכיתה:</p>
                                            <p className="text-slate-600 text-sm">טורים, שורות, שולחן, חלונות ודלת</p>
                                        </div>
                                    </div>

                                    <div className="flex gap-4 items-center">
                                        <div className="flex-shrink-0 w-8 h-8 bg-sky-100 text-sky-600 rounded-full flex items-center justify-center font-bold shadow-sm">2</div>
                                        <p className="font-bold text-slate-800 text-base">בחרו אסטרטגיית סידור לפי העדפה</p>
                                    </div>

                                    <div className="flex gap-4 items-center">
                                        <div className="flex-shrink-0 w-8 h-8 bg-amber-100 text-amber-600 rounded-full flex items-center justify-center font-bold shadow-sm">3</div>
                                        <p className="font-bold text-slate-800 text-base">הזינו רשימת תלמידים ולחצו "הוסף רשימה" <span className="text-rose-500">(חובה)</span></p>
                                    </div>

                                    <div className="flex gap-4 items-center">
                                        <div className="flex-shrink-0 w-8 h-8 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center font-bold shadow-sm">4</div>
                                        <p className="font-bold text-slate-800 text-base">לחצו על שם תלמיד לעריכת כרטיס אישי</p>
                                    </div>

                                    <div className="flex gap-4 items-center">
                                        <div className="flex-shrink-0 w-8 h-8 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center font-bold shadow-sm">5</div>
                                        <p className="font-bold text-slate-800 text-base">לחצו "צור מפת כיתה"</p>
                                    </div>

                                    <div className="flex gap-4 items-center bg-teal-50 p-4 rounded-xl border border-teal-200">
                                        <div className="flex-shrink-0 w-8 h-8 bg-teal-500 text-white rounded-full flex items-center justify-center font-bold shadow-md">6</div>
                                        <p className="font-bold text-teal-800 text-lg">שמרו את המפה</p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-teal-700 text-sm font-medium">
                                                    ברשימה שנוספה למטה לחצו על שם התלמיד לעריכת <span className="underline">כרטיס תלמיד</span> אישי.
                                                </p>
                                            </div>
                                        </div>
                    ...
                    <div className="text-center text-slate-500 p-10 bg-white rounded-lg shadow-md">
                        ...
                        {(chart.isCopy || (currentUserId && chart.ownerId !== currentUserId)) ? (
                            <div className="max-w-xl mx-auto text-right">
                                ...
                                <div className="space-y-6">
                                    <div className="flex gap-4 items-center">
                                        <div className="flex-shrink-0 w-8 h-8 bg-teal-100 text-teal-600 rounded-full flex items-center justify-center font-bold shadow-sm">1</div>
                                        <p className="font-bold text-slate-800 text-base">בחרו מספר קבוצות</p>
                                    </div>

                                    <div className="flex gap-4 items-center">
                                        <div className="flex-shrink-0 w-8 h-8 bg-sky-100 text-sky-600 rounded-full flex items-center justify-center font-bold shadow-sm">2</div>
                                        <p className="font-bold text-slate-800 text-base">בחרו שיטת חלוקה</p>
                                    </div>
                                    ...
                                    <div className="flex gap-4 items-center">
                                        <div className="flex-shrink-0 w-8 h-8 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center font-bold shadow-sm">5</div>
                                        <p className="font-bold text-slate-800 text-base">לחצו "צור קבוצות"</p>
                                    </div>

                                    <div className="flex gap-4 items-center bg-teal-50 p-4 rounded-xl border border-teal-200">
                                        <div className="flex-shrink-0 w-8 h-8 bg-teal-500 text-white rounded-full flex items-center justify-center font-bold shadow-md">6</div>
                                        <p className="font-bold text-teal-800 text-lg">שמרו את הקבוצה</p>
                                    </div>
                                </div>
                            </div>
                        ) : (
                            <div className="space-y-6 max-w-lg mx-auto py-4 text-right">
                                <div className="flex gap-4 items-center">
                                    <div className="flex-shrink-0 w-8 h-8 bg-teal-100 text-teal-600 rounded-full flex items-center justify-center font-bold shadow-sm">1</div>
                                    <p className="font-bold text-slate-800 text-base">בחרו מספר קבוצות</p>
                                </div>
                                    ...
                                    <>
                                        ...
                                        <div>
                                            <textarea 
                                                ...
                                                placeholder="הזן שם תלמיד או רשימת תלמידים (שם בשורה). הוסיפו נ או ז ליד כל שם." 
                                                className="w-full p-3 border rounded-md h-32 mb-2 text-base text-right"
                                            ></textarea>
                                            <button onClick={handleAddListStudents} className="w-full bg-teal-500 text-white p-3 rounded-md hover:bg-teal-600 flex items-center justify-center gap-2 font-bold transition-all active:scale-95">
                                                <PlusIcon className="h-6 w-6"/> הוסף רשימה וצור כרטיס לכל תלמיד
                                            </button>
                                            <p className="text-[10px] text-slate-500 text-center mt-1 font-medium">לחיצה כאן תשמור את התלמידים ותפתח עבורם כרטיסי עריכה אישיים</p>
                                        </div>
                                    </>
                                )}
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-teal-700 leading-relaxed">
                                                ...
                                                ברשימה למטה לחצו על שם התלמיד לעריכת כרטיס תלמיד אישי.
                                            </p>
                                        </div>
                                    </div>
                                </div>
